...
public class UserServiceTests {
    ...
    public void testCreateUserOK() throws Exception {
        ...
        assert existing_user.isPresent();
    ...
    public void testLogoutOK() throws Exception {
        ...
        assert !userRepository.findUserByEmail("logout_user_ok@test.com").get().getConnected();
    }
    ...
    public void testUpdateUserOKWithPasswordNull() throws Exception {
        ...
        assert userEntity.getFirstName().equals("test1")
            &&  userEntity.getLastName().equals("test1")
            &&  userEntity.getPassword().equals("0000");
    ...
    public void testUpdateUserOKWithPassword() throws Exception {
        ...
        assert userEntity.getFirstName().equals("test1")
            &&  userEntity.getLastName().equals("test1")
            &&  userEntity.getPassword().equals("1111");
    ...
    public void testGetUserByEmailOK() throws Exception {
        ...
        assert profileDto.getEmail().equals("connected_user@test.com");
    }
